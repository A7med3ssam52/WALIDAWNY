...
const ROUTES = [
  { path: '/', file: 'index.html', title: 'منصة وليد عونى التعليمية | دروس مصورة وملازم PDF لكل الصفوف', desc: 'منصة وليد عونى التعليمية المصرية — منهج منظم لكل صفوف الإعدادي والثانوي، فيديوهات شرح مبسطة، ملازم PDF وسبورات تفاعلية مع تفعيل فوري بكود WLDN. ابدأ الآن.', h1: 'وليد عونى — منصة تعليمية لطلاب إعدادي وثانوي' },
