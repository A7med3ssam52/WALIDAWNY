...
export const SEO = {
  home: {
    title: 'منصة وليد عونى التعليمية | دروس مصورة وملازم PDF لكل الصفوف',
    description:
      'منصة وليد عونى التعليمية المصرية — منهج منظم لكل صفوف الإعدادي والثانوي، فيديوهات شرح مبسطة، ملازم PDF وسبورات تفاعلية مع تفعيل فوري بكود WLDN. ابدأ الآن.',
    keywords:
      'وليد عونى, منصة وليد عونى, منصة تعليمية مصرية, دروس مصورة, ملازم PDF, سبورات, كود تفعيل WLDN, شرح منهج اعدادي وثانوي, وحدات مدى الحياة',
  },
  about: {
...
export const SHARED_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'المنصة تغطي صفوف الإعدادي (أولى وتانية وتالتة) وصفوف الثانوي بشكل متدرج — تصفح صفحة المواد لمعرفة الوحدات المتاحة لكل صف وأسعارها.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'نعم، المنصة تستخدم اتصال آمن HTTPS وتخزين مشفر عبر Supabase مع سياسة خصوصية واضحة — لا نشارك بياناتك مع أي طرف ثالث وتحكم كامل في حسابك.',
  },
];
